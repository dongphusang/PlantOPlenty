...
namespace PlantOPlenty
{
    class InfoBoardData
    {
        ...
        public string LuxValue { get; set; }// A plant recommeded lux value. decided right after PlantName is changed. Pulled up from an embedded file
        ...
        public InfoBoardData()
        {
            ...
            LuxValue = GetPlantLux();

            //debugging
            Console.WriteLine($"DEBUG: InfoBoardData.InfoBoardData().plantDescription.Debug => {PlantDescription}");
            Console.WriteLine($"DEBUG: InfoBoardData.InfoBoardData().luxValue.Debug => {LuxValue}");
